...
Esta página documenta os **37 requisitos funcionais (RF)** que o PGD Livre implementa, com rastreabilidade direta ao marco normativo federal e ao contrato da API PGD Central do MGI.

A cobertura segue três fontes:

- **Decreto nº 11.072/2022** — institui o Programa de Gestão e Desempenho.
- **IN Conjunta SEGES-SGPRT/MGI nº 24/2023** — regulamenta o teletrabalho e o PGD.
- **IN Conjunta SGP-SRT-SEGES/MGI nº 52/2023** — atualiza critérios, escalas de avaliação e procedimentos de RH.

Cada requisito carrega sua origem normativa, o papel responsável pela ação e o critério de aceitação verificável. É a referência usada pelo time para projetar, testar e auditar a plataforma.
...
Complementam os RFs e norteiam o projeto técnico:

- **RNF-001 — Disponibilidade:** disponibilidade mínima de 99,5% durante horário útil (07h–21h em dias úteis).
...
- **RNF-005 — Implantabilidade:** aplicação distribuída como imagem Docker com `docker-compose` para instalação simplificada pelo órgão.
