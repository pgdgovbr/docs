...
A tela **Equipe** é seu painel de controle da equipe. Ela mostra todos os servidores sob sua chefia e as pendências de cada um.
...
| **Status do PT** | Se tem Plano de Trabalho ativo |
| **Pendências** | Registros aguardando avaliação, recursos em aberto |

## Badges e indicadores

| Badge | Significado |
|---|---|
| `Sem PT` | O servidor não tem Plano de Trabalho vigente — você precisa criar |
...
**Servidor com badge "Sem PT":**
→ [Criar um Plano de Trabalho](criar-plano.md) para ele
